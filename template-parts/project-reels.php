      ...
      <div class="image-section col-xl-7 position-relative">
        <div class="row align-items-end gx-6">
          ...
          <div class="col-lg-6 d-flex flex-column">
            ...
            <a href="#" class="btn btn-primary btn-lg d-flex align-items-center justify-content-center text-uppercase rounded-0" data-aos="fade-left" data-aos-anchor-placement="top-bottom">
              See More
            </a>
          </div>
        </div>  
