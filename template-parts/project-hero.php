    ...
    <div class="swiper h-100">
      <div class="swiper-wrapper d-flex">
        <div class="swiper-slide">
          <img 
            src="<?= get_template_directory_uri() ?>/assets/tmp/project-slider/project-slide-1.webp" 
            alt="Stephanie & Eric" 
        ...
        <div class="swiper-slide">
          <img 
            src="<?= get_template_directory_uri() ?>/assets/tmp/project-slider/project-slide-2.webp" 
            alt="Stephanie & Eric" 
            class="object-fit-cover h-100 img-fluid"
          />
        </div>
        <div class="swiper-slide">
          <img 
            src="<?= get_template_directory_uri() ?>/assets/tmp/project-slider/project-slide-3.webp" 
            alt="Stephanie & Eric" 
            class="object-fit-cover h-100 img-fluid"
          />
        </div>
