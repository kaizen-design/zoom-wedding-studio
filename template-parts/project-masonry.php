<?php if($photography_gallery = get_field('photography_gallery')): ?>
  <section class="masonry-section">
    <div class="container-xl d-flex flex-column">
      <?php if (get_field('photography_title') || get_field('photography_description')): ?>
        <div class="section-header d-flex flex-column align-items-center text-center">
          <?php if($photography_title = get_field('photography_title')): ?>
            <h2 class="section-title h1 mb-0" data-aos="fade-up">
              <?= $photography_title ?>
            </h2>
          <?php endif; ?>
          <?php if($photography_description = get_field('photography_description')): ?>
            <p class="mb-0" data-aos="fade-up" data-aos-delay="300">
              <?= wp_kses_post($photography_description) ?>
            </p>
          <?php endif; ?>  
        </div> 
      <?php endif; ?>   
