<section class="projects-section">
  <div class="container-xl d-flex flex-column">
    <div class="section-header d-flex flex-column align-items-center text-center">
      <h2 class="mb-0" data-aos="fade-up">Gallery of magical moments we have created</h2>
      <p class="mb-0" data-aos="fade-up" data-aos-delay="300">It will be an excellent starting point to know your expectations.</p>
    </div>
        ...
        <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="<?= $delay ?>">
          <a href="#" class="project-card card text-white">
            ...
            <div class="card-img-overlay d-flex flex-column align-items-center justify-content-end">
              <h3 class="card-title mb-0">Rachel & Nicholas</h3>
