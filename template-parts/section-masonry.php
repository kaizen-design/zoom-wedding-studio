<section class="masonry-section">
  <div class="container-xl d-flex flex-column">
    <div class="section-header d-flex flex-column align-items-center text-center">
      <h2 class="section-title h1 mb-0" data-aos="fade-up">Wedding Photography</h2>
      <p class="mb-0" data-aos="fade-up" data-aos-delay="300">Each newlywed couple is a precious page from a huge wedding album that we create every day, every week, year after year!</p>
    </div>  
