      ...
      <div class="col-xl-7 offset-xl-2" data-aos="fade-up">
        <div class="slider-box d-flex flex-column">
          ...
          <div class="slider-footer d-flex align-items-center">
            <a href="#" class="btn btn-primary btn-lg d-flex align-items-center me-auto">
              View all
            ...
            <span class="slides-counter">01 / <span class="total">25</span></span>
            <ul class="slider-controls list-unstyled mb-0 d-flex align-items-center">
              <li>
