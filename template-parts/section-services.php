    ...
    <div class="services-box d-flex flex-column">
      ...
      <div class="row">
        ...
        <div class="col-8 col-md-9 col-lg-10 col-xl-9 section-content d-flex flex-column">
          <p class="mb-0" data-aos="fade-left" data-aos-delay="150" data-aos-anchor-placement="top-bottom">Zoom Wedding Studio offers you a full package of wedding services to&nbsp;create the best memories on your special day.</p>
          <ul class="services-list list-unstyled mb-0 d-flex flex-column flex-lg-row align-items-lg-center">
            <li class="d-flex align-items-center" data-aos="fade-left" data-aos-delay="300" data-aos-anchor-placement="top-bottom">
            ...
            <li class="d-none d-lg-flex" data-aos="fade-left" data-aos-delay="450" data-aos-anchor-placement="top-bottom">
            ...
            <li class="d-flex align-items-center" data-aos="fade-left" data-aos-delay="600" data-aos-anchor-placement="top-bottom">
              <svg class="d-lg-none" viewBox="0 0 256 256"><rect fill="none" height="256" width="256"/><path d="M176,32a60,60,0,0,0-48,24A60,60,0,0,0,20,92c0,71.9,99.9,128.6,104.1,131a7.8,7.8,0,0,0,3.9,1,7.6,7.6,0,0,0,3.9-1,314.3,314.3,0,0,0,51.5-37.6C218.3,154,236,122.6,236,92A60,60,0,0,0,176,32Z"/></svg>
              Videography
            </li>
            <li class="d-none d-lg-flex" data-aos="fade-left" data-aos-delay="750" data-aos-anchor-placement="top-bottom">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><rect fill="none" height="256" width="256"/><path d="M176,32a60,60,0,0,0-48,24A60,60,0,0,0,20,92c0,71.9,99.9,128.6,104.1,131a7.8,7.8,0,0,0,3.9,1,7.6,7.6,0,0,0,3.9-1,314.3,314.3,0,0,0,51.5-37.6C218.3,154,236,122.6,236,92A60,60,0,0,0,176,32Z"/></svg>
            </li>
            <li class="d-flex align-items-center" data-aos="fade-left" data-aos-delay="900" data-aos-anchor-placement="top-bottom">
              <svg class="d-lg-none" viewBox="0 0 256 256"><rect fill="none" height="256" width="256"/><path d="M176,32a60,60,0,0,0-48,24A60,60,0,0,0,20,92c0,71.9,99.9,128.6,104.1,131a7.8,7.8,0,0,0,3.9,1,7.6,7.6,0,0,0,3.9-1,314.3,314.3,0,0,0,51.5-37.6C218.3,154,236,122.6,236,92A60,60,0,0,0,176,32Z"/></svg>
              Wedding Album
            </li>
          </ul>
